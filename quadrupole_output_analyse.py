...
# plot_mcmc_quadrupole_out(folder,'profile_total.cat','tpwd',False,'out_mcmc_centred',4)
# plot_mcmc_quadrupole_out(folder,'profile_total.cat','tpwdl',False,'out_mcmc_centred',4)
