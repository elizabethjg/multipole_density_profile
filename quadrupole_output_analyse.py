...
plot_mcmc_quadrupole_out(folder,'profile_total.cat','t',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','twl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','twd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','tp',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','tpwl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','tpwd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','tpwdl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_total.cat','control',False,1,0,'out_mcmc_centred',4)
...
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','t',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','twl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','twd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','tp',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','tpwl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','tpwd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','tpwdl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin1.cat','control',False,1,0,'out_mcmc_centred',4)
...
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','t',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','twl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','twd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','tp',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','tpwl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','tpwd',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','tpwdl',False,1,0,'out_mcmc_centred',4)
plot_mcmc_quadrupole_out(folder,'profile_median_bin2.cat','control',False,1,0,'out_mcmc_centred',4)
